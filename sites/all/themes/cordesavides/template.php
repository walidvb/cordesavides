 ...
 */
function cordesavides_preprocess_page(&$variables) {
  $variables['content_width'] = _cordesavides_content_width();
  ...
  $variables['nav_style'] = _cordesavides_nav_style(theme_get_setting('nav_style'));
 ...
 */
function _cordesavides_content_width() {
  $sidebar_first_width = (_cordesavides_block_list('sidebar_first')) ? theme_get_setting('sidebar_first_width') : 0;
  $sidebar_second_width = (_cordesavides_block_list('sidebar_second')) ? theme_get_setting('sidebar_second_width') : 0;
 ...
 */
function _cordesavides_block_list($region) {
  $drupal_list = array();
 ...
 */
function _cordesavides_nav_style($theme_nav_style) {
